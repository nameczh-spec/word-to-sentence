...
### 已完成（2026-07-05更新）
- [x] **作文范文整合**：从42个md语料文件提取sampleData，整合到3个位置的writing.js（Web端/mobile/mobile/www）
  - 42/42套试卷作文范文完整（含Part A应用文和Part B大作文）
  - 含范文文本、范文解析、写作技巧、结构提示
- [x] **2012-1 Part B图片补充**：从新东方网站下载图画作文图片，同步到3个目录
- [x] **翻译analysis补充（阶段一）**：
  - 2000年：5句全部填充（句型结构+重点词汇+翻译技巧）
  - 2001年：5句全部填充（含num 34自行编写）
  - 2019-1年：5句全部修正（修复translation和analysis错位，填充num 47/50）
  - 剩余待处理：2005年、2011-1年（md语料句子与JSON句子严重错位，需重写md）
- [x] **数据校验**：所有修改文件哈希校验3目录一致，audit-data.js验证通过
- [x] **2005年翻译修正**：重写2005-1.md translationDB（欧洲电视行业主题，5句全部修正），同步更新2005.json翻译部分（rawText和sentences），3目录哈希一致
- [x] **2011年翻译修正**：重写2011-1.md translationDB（James Allen《As a Man Thinketh》主题，5句全部修正），同步更新2011-1.json翻译sentences，3目录哈希一致
- [x] **2005年作文核对**：逐项核对Part A辞职信和Part B养老"足球赛"，题目/图片/范文全部正确
- [x] **2011年作文修正**：
...
#### 优先级2：数据修复（遗留问题）
- [ ] 修复2001.json和2006.json格式错误
- [ ] 2013-2025年作文范文需要重新解析整合（脚本解析失败）

#### 优先级3：移动端剩余优化
- [ ] 移动端真题页面UI适配测试
- [ ] 建立Web端与移动端代码同步机制
- [ ] 小屏幕(<375px)文字可读性进一步优化
- [ ] 释义勾选框触控区域增大（当前15px，需增大至44px）
